...
class FTPTestCase(unittest.TestCase):
    """Tests for ftp.py"""
    inter_test_pause_dur = 0.2 # Errors occur sometimes when not enough time given to close the socket
    ...
    def test_standard(self):
        ...
        #reader = ipc.Reader('test_ftp.csv')
        #ts = reader.get_var("timestamp_s")
    ...
    def test_seq_data(self, fname='test_ftp.csv'):
        data = ftp.read_data(fname)
